...
class WxPayApi
{
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, 'D:\wwwroot\youyijia\web\pbooks\ThinkPHP\Extend\Library\ORG\WxpayAPI\cert\apiclient_cert.pem');
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, 'D:\wwwroot\youyijia\web\pbooks\ThinkPHP\Extend\Library\ORG\WxpayAPI\cert\apiclient_key.pem');
		}
		//post提交方式
